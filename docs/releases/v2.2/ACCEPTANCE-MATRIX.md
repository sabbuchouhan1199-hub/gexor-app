...
| `V22-USAGE-03` | `REQ-UX-006`, `REQ-USG-005` | Usage UI Display for Unpriced Pricing Version | `apps/web/src/Workspace.tsx` (line 96) | `VERIFIED_COMPLETE` | None | `npm run test` | Part 2 |
